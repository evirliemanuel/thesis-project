...
import com.lieverandiver.thesisproject.adapter.AssignmentResultAdapterF;
...
public class AssignmentResultActivityF extends AppCompatActivity {

    private static final String TAG = AssignmentResultActivityF.class.getSimpleName();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        AssignmentResultAdapterF simpleAssignmentAdapterF = new AssignmentResultAdapterF(AssignmentResultActivityF.this, resultList, assignment.getItemTotal());
                        LinearLayoutManager layoutManager = new LinearLayoutManager(AssignmentResultActivityF.this);
                        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);

                        recyclerViewView.setAdapter(simpleAssignmentAdapterF);
