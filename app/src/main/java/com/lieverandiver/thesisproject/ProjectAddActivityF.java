...
import com.lieverandiver.thesisproject.adapter.ProjectAdapterF;
...
public class ProjectAddActivityF extends AppCompatActivity implements ProjectAdapterF.OnClickListener,
        View.OnClickListener {

    private static final String TAG = ProjectAddActivityF.class.getSimpleName();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        ProjectAdapterF projectAdapter = new ProjectAdapterF(ProjectAddActivityF.this, projectList);

                        LinearLayoutManager layoutManager = new LinearLayoutManager(ProjectAddActivityF.this);
    ...
    public void onClick(Project project, long projectId) {
        ...
        intent.setClass(this, ProjectResultActivityF.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case add_add5 :
                Intent intent = getIntent().setClass(this, ProjectInputActivityF.class);
                startActivity(intent);
                break;
            case add_back5 :
                finish();
