...
import com.lieverandiver.thesisproject.adapter.AssignmentAdapterF;
...
public class AssignmentAddActivityF extends AppCompatActivity implements AssignmentAdapterF.OnClickListener,
        View.OnClickListener {

    private static final String TAG = AssignmentAddActivityF.class.getSimpleName();
    ...
    public void onClick(Assignment assignment, long assignmentId) {
        ...
        intent.setClass(this, AssignmentResultActivityF.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case add_add2 :
                Intent intent = getIntent().setClass(this, AssignmentInputActivityF.class);
                startActivity(intent);
                break;
            case add_back2 :
                finish();
