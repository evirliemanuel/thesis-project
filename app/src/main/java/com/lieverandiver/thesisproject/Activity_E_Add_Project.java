...
public class Activity_E_Add_Project extends AppCompatActivity implements ProjectAdapter.OnClickListener,
        View.OnClickListener {

    private static final String TAG = Activity_E_Add_Project.class.getSimpleName();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        ProjectAdapter projectAdapter = new ProjectAdapter(Activity_E_Add_Project.this, projectList);

                        LinearLayoutManager layoutManager = new LinearLayoutManager(Activity_E_Add_Project.this);
