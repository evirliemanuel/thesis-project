...
import com.lieverandiver.thesisproject.adapter.QuizInputAdapterF;
...
public class QuizInputActivityF extends AppCompatActivity implements View.OnClickListener {
    ...
    private QuizInputAdapterF studentAdapter;
