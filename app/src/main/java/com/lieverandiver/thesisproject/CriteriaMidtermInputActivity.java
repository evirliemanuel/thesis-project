...
public class CriteriaMidtermInputActivity extends AppCompatActivity{
        ...
        try {
            ...
            linearLayoutm.setOnClickListener(new Button.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    if(formula !=null) {
                        new FormulaHelper(CriteriaMidtermInputActivity.this).saveUser(
                                teacher.getId() + "-midterm", formula.getId());
                        Intent intent = new Intent(CriteriaMidtermInputActivity.this,
                                SubjectViewActivity.class);
                        intent.putExtra("subjectId", subject.getId());
                        startActivity(intent);
                        finish();
                    }else
                        Toast.makeText(CriteriaMidtermInputActivity.this,
