...
import com.lieverandiver.thesisproject.adapter.ExamAdapterF;
...
public class ExamAddActivityF extends AppCompatActivity implements ExamAdapterF.OnClickListener,
        View.OnClickListener {

    private static final String TAG = ExamAddActivityF.class.getSimpleName();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        recyclerView.setAdapter(examAdapterF);
    ...
    public void onClick(Exam exam, long examId) {
        ...
        intent.setClass(this, ExamResultActivityF.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case add_add4 :
                Intent intent = getIntent().setClass(this,ExamInputActivityF.class);
                startActivity(intent);
                break;
            case add_back4 :
                finish();
