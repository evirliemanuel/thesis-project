...
import com.lieverandiver.thesisproject.adapter.ProjectResultAdapterF;
...
public class ProjectResultActivityF extends AppCompatActivity {

    private static final String TAG = ProjectResultActivityF.class.getSimpleName();
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        recyclerViewView.setAdapter(simpleProjectAdapterF);
