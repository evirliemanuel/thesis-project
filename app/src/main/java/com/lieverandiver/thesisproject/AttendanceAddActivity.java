...
public class AttendanceAddActivity extends AppCompatActivity implements AttendanceAdapter.OnClickListener,
    ...
    private static final String TAG = AttendanceAddActivity.class.getSimpleName();
                    ...
                    public void run() {
                        try {
                            AttendanceAdapter attendanceAdapter =
                                    new AttendanceAdapter(AttendanceAddActivity.this, attendanceList);

                            LinearLayoutManager layoutManager = new LinearLayoutManager(AttendanceAddActivity.this);
    ...
    public void onClick(Attendance attendance, long attendanceId) {
        ...
        intent.setClass(this, AttendanceResultViewActivity.class);
