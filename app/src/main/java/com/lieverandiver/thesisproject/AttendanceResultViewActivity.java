            ...
            for (Student s : classService.getStudentList(classId)) {
                ...
                new Handler(getMainLooper()).post(new Runnable() {
                    ...
                    public void run() {
                            ...
                            AttendanceResultAdapter simpleAttendanceAdapter = new AttendanceResultAdapter(AttendanceResultViewActivity.this, resultList);
                            LinearLayoutManager layoutManager = new LinearLayoutManager(AttendanceResultViewActivity.this);
