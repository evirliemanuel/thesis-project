...
public class QuizAdapterF extends RecyclerView.Adapter<QuizAdapterF.QuizViewHolder> {
    ...
    private QuizAdapterF.OnClickListener onClickListener;
    ...
    public QuizAdapterF(Context context, List<Quiz> quizList) {
        ...
        if(context instanceof QuizAdapterF.OnClickListener)
            onClickListener = (QuizAdapterF.OnClickListener) context;
    }

    @Override
    public QuizAdapterF.QuizViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
