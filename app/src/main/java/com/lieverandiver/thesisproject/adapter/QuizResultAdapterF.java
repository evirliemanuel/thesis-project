...
public class QuizResultAdapterF extends RecyclerView
        .Adapter<QuizResultAdapterF.ProjectViewHolder> {
    ...
    public QuizResultAdapterF(Context context, List<QuizResult> resultList) {
