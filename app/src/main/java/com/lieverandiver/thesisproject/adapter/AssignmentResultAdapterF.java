...
public class AssignmentResultAdapterF extends RecyclerView
        .Adapter<AssignmentResultAdapterF.AssignmentViewHolder> {
    ...
    public AssignmentResultAdapterF(Context context, List<AssignmentResult> resultList) {
