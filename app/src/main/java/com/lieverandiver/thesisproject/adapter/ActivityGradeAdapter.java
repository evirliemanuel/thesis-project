...
public class ActivityGradeAdapter extends RecyclerView.Adapter<ActivityGradeAdapter.GradeViewHolder> {

    private Context context;
    private List<Grade> gradeList;
    private LayoutInflater layoutInflater;

    public ActivityGradeAdapter(Context context, List<Grade> gradeList, long termId) {
