...
public class AssignmentAdapterF extends RecyclerView.Adapter<AssignmentAdapterF.AssignmentHolder> {

    private Context context;
    private AssignmentAdapterF.OnClickListener onClickListener;
    ...
    public AssignmentAdapterF(Context context, List<Assignment> assignmentList) {
        ...
        if(context instanceof AssignmentAdapterF.OnClickListener)
            onClickListener = (AssignmentAdapterF.OnClickListener) context;
    }

    @Override
    public AssignmentAdapterF.AssignmentHolder onCreateViewHolder(ViewGroup parent, int viewType) {
